...
namespace SnakeLauncherWPF
{
    public partial class App : Application
    {
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            try
            {
                UpdateService.CleanupTempFiles();         // 清理 %TEMP%\SnakeLauncherUpdate 中 >24h 的 zip
                UpdateService.CleanupUpdaterTempDirs();   // 清理 %TEMP%\SnakeLauncherUpdater_* 中 >24h 的目录
                UpdateService.CleanupOldBackups();        // ★ 新增：清理安装目录里的 _backup_* 和 *.old_*
            }
            catch { }
